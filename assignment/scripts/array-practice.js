...
let favFoods = ['sandwiches', 'chili', 'jambalaya'];
...
console.log('Last food is', favFoods[2]);
...
favFoods.unshift('potato salad');
console.log('unshifted array', favFoods);
